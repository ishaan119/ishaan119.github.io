---
layout: post
title: "What Actually Happens When You Talk to a Language Model"
subtitle: "A trace through the seven files that make up a model"
series: "LLM Internals"
date: 2026-05-08
source_repo: https://github.com/ishaan119/understanding_llm_model_structure
hero_image: https://github.com/user-attachments/assets/48963b96-e8d7-42f2-8f5d-6721db0a0730
description: >-
  I opened the files that ship with Qwen2.5-1.5B and traced the path a
  sentence takes from typed text to generated answer: tokenizer, embedding
  matrix, 28 layers, and the tied output projection.
---
