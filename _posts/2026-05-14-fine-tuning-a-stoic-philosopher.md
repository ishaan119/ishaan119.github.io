---
layout: post
title: "Teaching a Small Model to Be a Stoic Philosopher"
subtitle: "A fine-tuning journal — SFT, then RFT"
series: "LLM Internals"
date: 2026-05-14
source_repo: https://github.com/ishaan119/stoa_llm_model
hero_image: https://github.com/user-attachments/assets/7dbd7a2c-05d4-4986-8226-03d97c9539aa
description: >-
  I wanted to learn what fine-tuning actually does, so I built Stoa:
  Qwen2.5-1.5B turned into a Stoic philosopher. Supervised fine-tuning
  first, then reinforcement, and what each step did and didn't fix.
---
